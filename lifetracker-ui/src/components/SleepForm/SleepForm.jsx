...
export default function SleepForm(props){
   ...
   const handleOnSubmit = async (e) => {
       e.preventDefault()
       setIsLoading(true)
       const { data, error } = await apiClient.createSleep({start_time: form.start_time, end_time: form.end_time})
       if(error){
           setErrors(error)
       }
       if(data){
            ...
            <div className="container">
                ...
                <div className="inputs">
                    <div className="form-input">
                        ...
                        <input type="datetime-local" name="start_time" value={form.start_time} onChange={handleOnInputChange}/>
                        {errors.start_time && <span className="error">{errors.start_time}</span>}
                    </div>
                    <div className="form-input">
                        <label for="end_time">End Time</label>
                        <input type="datetime-local" name="end_time" value={form.end_time} onChange={handleOnInputChange}/>
