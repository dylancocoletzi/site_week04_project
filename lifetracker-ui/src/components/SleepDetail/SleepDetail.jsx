...
export default function SleepDetail(props){
    ...
    const overview = [
        { id: 1, day: "Jul 1st, 2022", start: "4:00pm", end: "1:00am", slept: "9 hours" },
        { id: 2, day: "Jul 2nd, 2022", start: "9:00pm", end: "6:00am", slept: "9 hours" },
        { id: 3, day: "Jul 3rd, 2022", start: "11:00pm", end: "7:00am", slept: "8 hours" },
        { id: 4, day: "Jul 4th, 2022", start: "11:00pm", end: "5:00am", slept: "6 hours" }
    ]
    return (
